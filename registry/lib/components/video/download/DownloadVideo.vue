  ...
  >
    ...
    <div class="download-video-panel-content">
      <div v-if="selectedInput" class="download-video-config-item">
        ...
        <VDropdown :value="selectedInput" :items="inputs" @change="selectedInput = $event" />
      </div>
      ...
      <div v-if="selectedApi" class="download-video-config-item">
        ...
        <VDropdown :value="selectedApi" :items="apis" @change="selectedApi = $event" />
      </div>
      <div
      ...
      <div class="download-video-config-item">
        ...
        <VDropdown
          :value="preferredUrlType"
          :items="urlTypeOptions"
          @change="preferredUrlType = $event"
        />
      </div>
      ...
      <div v-if="selectedOutput" class="download-video-config-item">
        ...
        <VDropdown :value="selectedOutput" :items="outputs" @change="selectedOutput = $event" />
      </div>
      <div
...
import { type TestPattern, type WithAttrs } from '@/core/common-types'
...
import { allQualities, type VideoQuality } from '@/components/video/video-quality'
