import { type RegexTranslation, type Translation } from '@/components/i18n/types'
...
export const map = new Map<string, Translation>([
  ...
  ['有新动态，点击查看', '新しいフィードがある、クリックして見る'],
  ['以上为热门评论，', '以上が人気コメント'],
  [
    '请自觉遵守互联网相关的政策法规，严禁发布色情、暴力、反动的言论。',
    'インターネット関連のポリシーや規制を意識的に遵守し、ポルノ・暴力・反動的な発言を厳禁してください。',
  ],
  ['点击查看', 'クリックして見る'],
  ['刚刚', 'さっき'],
  ['转发动态', '転載'],
  ...
  ['隐藏视频推荐', 'おすすめ動画を隠す'],
  ['隐藏分区栏', 'エリア欄を隠す'],
  ['解除动态存图限制', 'フィード画像の保存制限を解除'],
  ['快速收起动态评论区', 'すぐにコメントを閉じる'],
  ['收起评论', 'コメントを閉じる'],
  ['展开动态标题', 'フィードのタイトルを表示'],
  ['展开动态内容', 'フィードを全表示'],
  ['旧版动态跳转支持', '旧版のフィードをジャンプ'],
  ['动态过滤器', 'フィードフィルター'],
  ['动态过滤', 'フィードフィルター'],
  ['关键词', 'キーワード'],
  ['支持正则表达式 /^xxx$/', '正規表現サポート /^xxx$/'],
  ['侧边栏', 'サイドカード'],
  ['个人资料', '個人情報'],
  ['关注栏', '関心人欄'],
  ['动态翻译', 'フィード翻訳'],
  ...
  ['失效视频重定向', '失効動画をリダイレクト'],
  ['信息来源', '情報源'],
  ['BiliPlus跳转支持', 'BiliPlusをジャンプ'],
  ['高分辨率图片', '高解像度画像'],
  ['界面翻译', 'UI 翻訳'],
  ['语言', '言語'],
  ['禁止直播首页自动播放', '生放送のホームページの自動再生を禁止'],
  ['隐藏首页推荐直播', 'ホームページのおすすめを隠した'],
  ['瓜子换硬币', 'ヒマワリの種交換'],
  ['每天最多能兑换 1 个', '1 日 1 回まで引き換える'],
  ['直播间自动领奖', '配信ルームに自動抽選'],
  ...
  ['启用双击控制', 'ダブルクリック制御'],
  ['迷你播放器触摸拖动', 'ミニプレーヤーはタッチドラッグをサポート'],
  ['显示消息', 'メッセージを表示'],
  ...
  ['自动隐藏侧栏', '設定ボタンを自動的に隠す'],
  ['启用 Ajax Hook API', 'Ajax Hook APIを有効にする'],
  ['加载模式', '読み込みモード'],
  ['同时', '同時'],
  ['延后', '延後'],
  ['同时(自动)', '同時(自動)'],
  ...
  [
    ...
    '警告：動画サイズが大きすぎると、直接ダウンロードしたときに大量のメモリを占有する、ブラウザのタブがクラッシュする可能性があります.解像度を下げて、あるいはデータをエクスポートことを考えてください.',
  ],
  ['格式', 'フォーマット'],
  ['清晰度', '解像度'],
  ['无', '無'],
  ...
  ['导出vld数据', 'vld'],
  ['显示链接', 'リンクを表示'],
  ['ffmpeg - 分段列表', 'ffmpeg - セグメントリスト'],
  ['ffmpeg - 分P列表', 'ffmpeg - エピソードリスト'],
  ...
  [
    ...
    '（最大100pの動画を一度にアップロードできますが、監査やトランスコードにかかる時間を短縮するために、「MP4」や「FLV」形式を使用することをお勧めします）',
  ],
  ['上传完成', 'アップロード完成'],
  ['添加视频', '動画を追加'],
  ['视频封面设置', '動画のサムネイルを設置'],
  [
    ...
    '（形式はjpeg/png、ファイルサイズ≤5MB、推奨サイズ≥1146*717、最小サイズ≥960*600）',
  ],
  ['类型', 'タイプ'],
  ['分区', 'エリア'],
  ['全部分区', 'すべてのエリア'],
  ...
  [
    '已成功导入设置, 部分设置需要刷新后生效.',
    '設定は正常にインポートされました、一部の設定を有効にするには更新する必要があります.',
  ],
  ['选择的设置文件无效.', '選択したの設定ファイルは無効です.'],
  [
    '主线',
    [
      '主路線',
      {
        text: '主要',
        selector: '.link-radio-button-label',
      },
    ],
  ],
  [
