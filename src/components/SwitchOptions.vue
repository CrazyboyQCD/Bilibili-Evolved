<template>
  <div ref="root" class="switch-options" :class="{ 'small-size': smallSize, grid: !popupMode }">
...
import { type SwitchMetadataOption } from './switch-options'
...
const {
  ...
  options: SwitchMetadataOption<any, any>
  smallSize?: boolean
  popupMode?: boolean
}>()
