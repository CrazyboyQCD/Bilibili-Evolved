...
import { type ComponentSettings, type Settings, type ValueChangeListener } from './types'
...
import { type ComponentMetadata, componentsMap, type UnknownOptions } from '@/components/component'
