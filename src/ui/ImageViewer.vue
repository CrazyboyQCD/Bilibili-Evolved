  ...
  <div class="image-viewer-container" :class="{ open }" @click="detectOutside">
    <div ref="viewer" class="image-viewer">
      ...
      <a
        ...
        :download="filename"
      >
        <VIcon :size="48" icon="mdi-download" />
      </a>
    </div>
  </div>
</template>
